object "a" {
    code {
        pop(eofcreate("s0000", 0, 0, 0, 0))
        pop(eofcreate("s0001", 0, 0, 0, 0))
        pop(eofcreate("s0002", 0, 0, 0, 0))
        pop(eofcreate("s0003", 0, 0, 0, 0))
        pop(eofcreate("s0004", 0, 0, 0, 0))
        pop(eofcreate("s0005", 0, 0, 0, 0))
        pop(eofcreate("s0006", 0, 0, 0, 0))
        pop(eofcreate("s0007", 0, 0, 0, 0))
        pop(eofcreate("s0008", 0, 0, 0, 0))
        pop(eofcreate("s0009", 0, 0, 0, 0))
        pop(eofcreate("s0010", 0, 0, 0, 0))
        pop(eofcreate("s0011", 0, 0, 0, 0))
        pop(eofcreate("s0012", 0, 0, 0, 0))
        pop(eofcreate("s0013", 0, 0, 0, 0))
        pop(eofcreate("s0014", 0, 0, 0, 0))
        pop(eofcreate("s0015", 0, 0, 0, 0))
        pop(eofcreate("s0016", 0, 0, 0, 0))
        pop(eofcreate("s0017", 0, 0, 0, 0))
        pop(eofcreate("s0018", 0, 0, 0, 0))
        pop(eofcreate("s0019", 0, 0, 0, 0))
        pop(eofcreate("s0020", 0, 0, 0, 0))
        pop(eofcreate("s0021", 0, 0, 0, 0))
        pop(eofcreate("s0022", 0, 0, 0, 0))
        pop(eofcreate("s0023", 0, 0, 0, 0))
        pop(eofcreate("s0024", 0, 0, 0, 0))
        pop(eofcreate("s0025", 0, 0, 0, 0))
        pop(eofcreate("s0026", 0, 0, 0, 0))
        pop(eofcreate("s0027", 0, 0, 0, 0))
        pop(eofcreate("s0028", 0, 0, 0, 0))
        pop(eofcreate("s0029", 0, 0, 0, 0))
        pop(eofcreate("s0030", 0, 0, 0, 0))
        pop(eofcreate("s0031", 0, 0, 0, 0))
        pop(eofcreate("s0032", 0, 0, 0, 0))
        pop(eofcreate("s0033", 0, 0, 0, 0))
        pop(eofcreate("s0034", 0, 0, 0, 0))
        pop(eofcreate("s0035", 0, 0, 0, 0))
        pop(eofcreate("s0036", 0, 0, 0, 0))
        pop(eofcreate("s0037", 0, 0, 0, 0))
        pop(eofcreate("s0038", 0, 0, 0, 0))
        pop(eofcreate("s0039", 0, 0, 0, 0))
        pop(eofcreate("s0040", 0, 0, 0, 0))
        pop(eofcreate("s0041", 0, 0, 0, 0))
        pop(eofcreate("s0042", 0, 0, 0, 0))
        pop(eofcreate("s0043", 0, 0, 0, 0))
        pop(eofcreate("s0044", 0, 0, 0, 0))
        pop(eofcreate("s0045", 0, 0, 0, 0))
        pop(eofcreate("s0046", 0, 0, 0, 0))
        pop(eofcreate("s0047", 0, 0, 0, 0))
        pop(eofcreate("s0048", 0, 0, 0, 0))
        pop(eofcreate("s0049", 0, 0, 0, 0))
        pop(eofcreate("s0050", 0, 0, 0, 0))
        pop(eofcreate("s0051", 0, 0, 0, 0))
        pop(eofcreate("s0052", 0, 0, 0, 0))
        pop(eofcreate("s0053", 0, 0, 0, 0))
        pop(eofcreate("s0054", 0, 0, 0, 0))
        pop(eofcreate("s0055", 0, 0, 0, 0))
        pop(eofcreate("s0056", 0, 0, 0, 0))
        pop(eofcreate("s0057", 0, 0, 0, 0))
        pop(eofcreate("s0058", 0, 0, 0, 0))
        pop(eofcreate("s0059", 0, 0, 0, 0))
        pop(eofcreate("s0060", 0, 0, 0, 0))
        pop(eofcreate("s0061", 0, 0, 0, 0))
        pop(eofcreate("s0062", 0, 0, 0, 0))
        pop(eofcreate("s0063", 0, 0, 0, 0))
        pop(eofcreate("s0064", 0, 0, 0, 0))
        pop(eofcreate("s0065", 0, 0, 0, 0))
        pop(eofcreate("s0066", 0, 0, 0, 0))
        pop(eofcreate("s0067", 0, 0, 0, 0))
        pop(eofcreate("s0068", 0, 0, 0, 0))
        pop(eofcreate("s0069", 0, 0, 0, 0))
        pop(eofcreate("s0070", 0, 0, 0, 0))
        pop(eofcreate("s0071", 0, 0, 0, 0))
        pop(eofcreate("s0072", 0, 0, 0, 0))
        pop(eofcreate("s0073", 0, 0, 0, 0))
        pop(eofcreate("s0074", 0, 0, 0, 0))
        pop(eofcreate("s0075", 0, 0, 0, 0))
        pop(eofcreate("s0076", 0, 0, 0, 0))
        pop(eofcreate("s0077", 0, 0, 0, 0))
        pop(eofcreate("s0078", 0, 0, 0, 0))
        pop(eofcreate("s0079", 0, 0, 0, 0))
        pop(eofcreate("s0080", 0, 0, 0, 0))
        pop(eofcreate("s0081", 0, 0, 0, 0))
        pop(eofcreate("s0082", 0, 0, 0, 0))
        pop(eofcreate("s0083", 0, 0, 0, 0))
        pop(eofcreate("s0084", 0, 0, 0, 0))
        pop(eofcreate("s0085", 0, 0, 0, 0))
        pop(eofcreate("s0086", 0, 0, 0, 0))
        pop(eofcreate("s0087", 0, 0, 0, 0))
        pop(eofcreate("s0088", 0, 0, 0, 0))
        pop(eofcreate("s0089", 0, 0, 0, 0))
        pop(eofcreate("s0090", 0, 0, 0, 0))
        pop(eofcreate("s0091", 0, 0, 0, 0))
        pop(eofcreate("s0092", 0, 0, 0, 0))
        pop(eofcreate("s0093", 0, 0, 0, 0))
        pop(eofcreate("s0094", 0, 0, 0, 0))
        pop(eofcreate("s0095", 0, 0, 0, 0))
        pop(eofcreate("s0096", 0, 0, 0, 0))
        pop(eofcreate("s0097", 0, 0, 0, 0))
        pop(eofcreate("s0098", 0, 0, 0, 0))
        pop(eofcreate("s0099", 0, 0, 0, 0))
        pop(eofcreate("s0100", 0, 0, 0, 0))
        pop(eofcreate("s0101", 0, 0, 0, 0))
        pop(eofcreate("s0102", 0, 0, 0, 0))
        pop(eofcreate("s0103", 0, 0, 0, 0))
        pop(eofcreate("s0104", 0, 0, 0, 0))
        pop(eofcreate("s0105", 0, 0, 0, 0))
        pop(eofcreate("s0106", 0, 0, 0, 0))
        pop(eofcreate("s0107", 0, 0, 0, 0))
        pop(eofcreate("s0108", 0, 0, 0, 0))
        pop(eofcreate("s0109", 0, 0, 0, 0))
        pop(eofcreate("s0110", 0, 0, 0, 0))
        pop(eofcreate("s0111", 0, 0, 0, 0))
        pop(eofcreate("s0112", 0, 0, 0, 0))
        pop(eofcreate("s0113", 0, 0, 0, 0))
        pop(eofcreate("s0114", 0, 0, 0, 0))
        pop(eofcreate("s0115", 0, 0, 0, 0))
        pop(eofcreate("s0116", 0, 0, 0, 0))
        pop(eofcreate("s0117", 0, 0, 0, 0))
        pop(eofcreate("s0118", 0, 0, 0, 0))
        pop(eofcreate("s0119", 0, 0, 0, 0))
        pop(eofcreate("s0120", 0, 0, 0, 0))
        pop(eofcreate("s0121", 0, 0, 0, 0))
        pop(eofcreate("s0122", 0, 0, 0, 0))
        pop(eofcreate("s0123", 0, 0, 0, 0))
        pop(eofcreate("s0124", 0, 0, 0, 0))
        pop(eofcreate("s0125", 0, 0, 0, 0))
        pop(eofcreate("s0126", 0, 0, 0, 0))
        pop(eofcreate("s0127", 0, 0, 0, 0))
        pop(eofcreate("s0128", 0, 0, 0, 0))
        pop(eofcreate("s0129", 0, 0, 0, 0))
        pop(eofcreate("s0130", 0, 0, 0, 0))
        pop(eofcreate("s0131", 0, 0, 0, 0))
        pop(eofcreate("s0132", 0, 0, 0, 0))
        pop(eofcreate("s0133", 0, 0, 0, 0))
        pop(eofcreate("s0134", 0, 0, 0, 0))
        pop(eofcreate("s0135", 0, 0, 0, 0))
        pop(eofcreate("s0136", 0, 0, 0, 0))
        pop(eofcreate("s0137", 0, 0, 0, 0))
        pop(eofcreate("s0138", 0, 0, 0, 0))
        pop(eofcreate("s0139", 0, 0, 0, 0))
        pop(eofcreate("s0140", 0, 0, 0, 0))
        pop(eofcreate("s0141", 0, 0, 0, 0))
        pop(eofcreate("s0142", 0, 0, 0, 0))
        pop(eofcreate("s0143", 0, 0, 0, 0))
        pop(eofcreate("s0144", 0, 0, 0, 0))
        pop(eofcreate("s0145", 0, 0, 0, 0))
        pop(eofcreate("s0146", 0, 0, 0, 0))
        pop(eofcreate("s0147", 0, 0, 0, 0))
        pop(eofcreate("s0148", 0, 0, 0, 0))
        pop(eofcreate("s0149", 0, 0, 0, 0))
        pop(eofcreate("s0150", 0, 0, 0, 0))
        pop(eofcreate("s0151", 0, 0, 0, 0))
        pop(eofcreate("s0152", 0, 0, 0, 0))
        pop(eofcreate("s0153", 0, 0, 0, 0))
        pop(eofcreate("s0154", 0, 0, 0, 0))
        pop(eofcreate("s0155", 0, 0, 0, 0))
        pop(eofcreate("s0156", 0, 0, 0, 0))
        pop(eofcreate("s0157", 0, 0, 0, 0))
        pop(eofcreate("s0158", 0, 0, 0, 0))
        pop(eofcreate("s0159", 0, 0, 0, 0))
        pop(eofcreate("s0160", 0, 0, 0, 0))
        pop(eofcreate("s0161", 0, 0, 0, 0))
        pop(eofcreate("s0162", 0, 0, 0, 0))
        pop(eofcreate("s0163", 0, 0, 0, 0))
        pop(eofcreate("s0164", 0, 0, 0, 0))
        pop(eofcreate("s0165", 0, 0, 0, 0))
        pop(eofcreate("s0166", 0, 0, 0, 0))
        pop(eofcreate("s0167", 0, 0, 0, 0))
        pop(eofcreate("s0168", 0, 0, 0, 0))
        pop(eofcreate("s0169", 0, 0, 0, 0))
        pop(eofcreate("s0170", 0, 0, 0, 0))
        pop(eofcreate("s0171", 0, 0, 0, 0))
        pop(eofcreate("s0172", 0, 0, 0, 0))
        pop(eofcreate("s0173", 0, 0, 0, 0))
        pop(eofcreate("s0174", 0, 0, 0, 0))
        pop(eofcreate("s0175", 0, 0, 0, 0))
        pop(eofcreate("s0176", 0, 0, 0, 0))
        pop(eofcreate("s0177", 0, 0, 0, 0))
        pop(eofcreate("s0178", 0, 0, 0, 0))
        pop(eofcreate("s0179", 0, 0, 0, 0))
        pop(eofcreate("s0180", 0, 0, 0, 0))
        pop(eofcreate("s0181", 0, 0, 0, 0))
        pop(eofcreate("s0182", 0, 0, 0, 0))
        pop(eofcreate("s0183", 0, 0, 0, 0))
        pop(eofcreate("s0184", 0, 0, 0, 0))
        pop(eofcreate("s0185", 0, 0, 0, 0))
        pop(eofcreate("s0186", 0, 0, 0, 0))
        pop(eofcreate("s0187", 0, 0, 0, 0))
        pop(eofcreate("s0188", 0, 0, 0, 0))
        pop(eofcreate("s0189", 0, 0, 0, 0))
        pop(eofcreate("s0190", 0, 0, 0, 0))
        pop(eofcreate("s0191", 0, 0, 0, 0))
        pop(eofcreate("s0192", 0, 0, 0, 0))
        pop(eofcreate("s0193", 0, 0, 0, 0))
        pop(eofcreate("s0194", 0, 0, 0, 0))
        pop(eofcreate("s0195", 0, 0, 0, 0))
        pop(eofcreate("s0196", 0, 0, 0, 0))
        pop(eofcreate("s0197", 0, 0, 0, 0))
        pop(eofcreate("s0198", 0, 0, 0, 0))
        pop(eofcreate("s0199", 0, 0, 0, 0))
        pop(eofcreate("s0200", 0, 0, 0, 0))
        pop(eofcreate("s0201", 0, 0, 0, 0))
        pop(eofcreate("s0202", 0, 0, 0, 0))
        pop(eofcreate("s0203", 0, 0, 0, 0))
        pop(eofcreate("s0204", 0, 0, 0, 0))
        pop(eofcreate("s0205", 0, 0, 0, 0))
        pop(eofcreate("s0206", 0, 0, 0, 0))
        pop(eofcreate("s0207", 0, 0, 0, 0))
        pop(eofcreate("s0208", 0, 0, 0, 0))
        pop(eofcreate("s0209", 0, 0, 0, 0))
        pop(eofcreate("s0210", 0, 0, 0, 0))
        pop(eofcreate("s0211", 0, 0, 0, 0))
        pop(eofcreate("s0212", 0, 0, 0, 0))
        pop(eofcreate("s0213", 0, 0, 0, 0))
        pop(eofcreate("s0214", 0, 0, 0, 0))
        pop(eofcreate("s0215", 0, 0, 0, 0))
        pop(eofcreate("s0216", 0, 0, 0, 0))
        pop(eofcreate("s0217", 0, 0, 0, 0))
        pop(eofcreate("s0218", 0, 0, 0, 0))
        pop(eofcreate("s0219", 0, 0, 0, 0))
        pop(eofcreate("s0220", 0, 0, 0, 0))
        pop(eofcreate("s0221", 0, 0, 0, 0))
        pop(eofcreate("s0222", 0, 0, 0, 0))
        pop(eofcreate("s0223", 0, 0, 0, 0))
        pop(eofcreate("s0224", 0, 0, 0, 0))
        pop(eofcreate("s0225", 0, 0, 0, 0))
        pop(eofcreate("s0226", 0, 0, 0, 0))
        pop(eofcreate("s0227", 0, 0, 0, 0))
        pop(eofcreate("s0228", 0, 0, 0, 0))
        pop(eofcreate("s0229", 0, 0, 0, 0))
        pop(eofcreate("s0230", 0, 0, 0, 0))
        pop(eofcreate("s0231", 0, 0, 0, 0))
        pop(eofcreate("s0232", 0, 0, 0, 0))
        pop(eofcreate("s0233", 0, 0, 0, 0))
        pop(eofcreate("s0234", 0, 0, 0, 0))
        pop(eofcreate("s0235", 0, 0, 0, 0))
        pop(eofcreate("s0236", 0, 0, 0, 0))
        pop(eofcreate("s0237", 0, 0, 0, 0))
        pop(eofcreate("s0238", 0, 0, 0, 0))
        pop(eofcreate("s0239", 0, 0, 0, 0))
        pop(eofcreate("s0240", 0, 0, 0, 0))
        pop(eofcreate("s0241", 0, 0, 0, 0))
        pop(eofcreate("s0242", 0, 0, 0, 0))
        pop(eofcreate("s0243", 0, 0, 0, 0))
        pop(eofcreate("s0244", 0, 0, 0, 0))
        pop(eofcreate("s0245", 0, 0, 0, 0))
        pop(eofcreate("s0246", 0, 0, 0, 0))
        pop(eofcreate("s0247", 0, 0, 0, 0))
        pop(eofcreate("s0248", 0, 0, 0, 0))
        pop(eofcreate("s0249", 0, 0, 0, 0))
        pop(eofcreate("s0250", 0, 0, 0, 0))
        pop(eofcreate("s0251", 0, 0, 0, 0))
        pop(eofcreate("s0252", 0, 0, 0, 0))
        pop(eofcreate("s0253", 0, 0, 0, 0))
        pop(eofcreate("s0254", 0, 0, 0, 0))
        pop(eofcreate("s0255", 0, 0, 0, 0))
    }
